    ...
    const fetchClickData = async () => {
      ...
      try {
        ...
        if (!advertiserDataString) {
          throw new Error("Advertiser data not found in local storage.");
        }
        ...
        const url = `${API_BASE}advertiser/advertiserClickList?partners_Id=${partners_Id}&advertiser_id=${advertiserId}&page=${currentPage}`;
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {clicks.map((click, index) => (
                <div
                  key={click._id}
                  className="group relative overflow-hidden bg-gradient-to-r from-white to-gray-50/50 rounded-xl p-4 border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
                  style={{
                ...
                >
                  <div className="flex items-center justify-between flex-wrap gap-y-3">
                    ...
                    {/* Geo Part - Enhanced */}
                    <div className="flex items-center space-x-2 bg-blue-50/50 px-4 py-2 rounded-full border border-blue-100 shadow-sm text-blue-800 font-semibold text-base min-w-[150px] justify-center">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1">
                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg flex items-center justify-center font-bold">
                  {currentPage}
                </div>
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:from-blue-600 hover:to-purple-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
...
const ConversionReportTable = () => {
  ...
  useEffect(() => {
    const fetchConversionData = async () => {
      ...
      try {
        ...
        // Support both advertiserId and publisherId
        const advertiserId = advertiserData.advertiserId || advertiserData.publisherId;
        const url = `${API_BASE}advertiser/advertiserConversionList?partners_Id=${partners_Id}&advertiserId=${advertiserId}&page=${currentPage}`;
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-1 bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 rounded-2xl blur opacity-20"></div>
      <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-6 lg:p-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-800 flex items-center space-x-2">
        ...
        {!isLoading && !error && conversions.length > 0 && (
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              onClick={handleNextPage}
              disabled={currentPage >= totalPages}
              className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              <span className="font-medium">Next</span>
              <ChevronsRight size={18} />
            </button>
...
export default function ClickConversionDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 lg:p-2">
      {/* Header Section */}
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
          ...
          {/* <div className="flex space-x-3">
            ...
            <button className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg">
