                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                                <Card className="lg:col-span-1 p-6 flex flex-col justify-center bg-blue-50 border border-blue-200 rounded-lg shadow-sm">
                                ...
                                <Card className="lg:col-span-2 p-6 flex flex-col justify-center bg-white border border-gray-200 rounded-lg shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <Button variant="outline" className="w-full border-blue-500 text-blue-500 hover:bg-blue-50 hover:text-blue-600 font-semibold py-3 text-base">
                            ...
                            <div className="my-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {/* Platinum Plan */}
                                    <div className="relative border  rounded-lg p-6 text-center hover:shadow-xl border-purple-400 transition-all duration-300 cursor-pointer">
                                         <div className="absolute top-0 right-0 m-4 px-3 py-1 bg-purple-100 text-purple-800 text-xs font-bold rounded-full">Best Value</div>
                                        <Gem className="mx-auto h-12 w-12 text-purple-500 mb-4" />
                                        <h3 className="text-xl font-bold text-gray-800">Platinum Plan</h3>
                                        <p className="text-3xl font-bold text-purple-600 my-2">$100</p>
