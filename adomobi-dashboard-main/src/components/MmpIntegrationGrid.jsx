  ...
  switch (status) {
    case "connected":
      return {
        ...
        buttonColor: "bg-teal-600 hover:bg-teal-700 text-white shadow-lg shadow-teal-500/30",
    ...
    case "setup":
      return {
        ...
        buttonColor: "bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-500/30",
...
export default function MmpIntegrationGrid() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-teal-50 to-blue-100 p-4 sm:p-6 lg:p-8 font-sans">
      <div className="max-w-8xl mx-auto">
        <div className="mb-12 text-center">
          <h1 className="text-3xl font-extrabold text-teal-900 tracking-tight sm:text-4xl animate-fade-in-down">
            Seamless Integrations
          </h1>
          <p className="mt-3 max-w-3xl mx-auto text-md text-teal-700 animate-fade-in-up">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  `focus-within:ring-4 ${config.ringColor} focus-within:ring-offset-4 focus-within:ring-offset-teal-50`
                )}
              >
