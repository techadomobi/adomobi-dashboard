    ...
    return () => {
      return (
        <div className="flex h-full flex-col bg-white border-r border-gray-200 shadow-xl">
          {/* Enhanced Logo area */}
          <div className="py-6 px-4 bg-gradient-to-r from-blue-50 via-white to-blue-50 border-b border-gray-200 flex justify-center items-center relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-50/30 to-blue-100/20"></div>
            {logoError ? (
              <div className="h-9 w-32 bg-gradient-to-r from-blue-200 to-blue-300 animate-pulse rounded-lg shadow-sm"></div>
            ) : (
              <div className="relative group">
                ...
                />
                <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-16 h-0.5 bg-gradient-to-r from-transparent via-blue-500/70 to-transparent rounded-full"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-100/20 to-blue-200/20 rounded-lg blur-xl group-hover:blur-2xl transition-all duration-300 -z-10"></div>
              </div>
            )}
          </div>

          {/* Enhanced Navigation */}
          <nav className="flex-1 space-y-1.5 p-3 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300/50 scrollbar-track-transparent" aria-label="Sidebar Navigation">
              ...
              <div key={item.label} className="relative">
                {item.hasSubmenu ? (
                  <div
                    className={cn(
                      ...
                      openSubmenu === item.label
                        ? "bg-blue-50 text-blue-700 shadow-md border border-blue-200/50 scale-[1.01]"
                        : "text-gray-700 hover:bg-blue-50 hover:text-blue-700 hover:shadow-sm hover:scale-[1.005]"
                    )}
                    onClick={() =>
                      setOpenSubmenu(
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        ...
                        <item.icon className={cn(
                          ...
                          openSubmenu === item.label ? "text-blue-600" : "text-gray-600 group-hover:text-blue-600"
                        )} aria-hidden="true" />
                      </div>
                    ...
                    {item.hasSubmenu &&
                      (openSubmenu === item.label ? (
                        <ChevronUp className="h-4 w-4 text-blue-500 transition-transform duration-300 rotate-0" aria-hidden="true" />
                      ) : (
                        <ChevronDown className="h-4 w-4 text-gray-400 group-hover:text-blue-500 transition-all duration-300" aria-hidden="true" />
                      ))}
                  </div>
                ) : (
                  <Link
                    ...
                    className={cn(
                      ...
                      pathname === item.href
                        ? "bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg border border-blue-500/50 transform scale-[1.02]"
                        : "text-gray-700 hover:bg-blue-50 hover:text-blue-700 hover:shadow-sm hover:scale-[1.005]"
                    )}
                  >
                    <div className="flex items-center gap-3">
                ...
                {item.hasSubmenu && openSubmenu === item.label && (
                  <div className="mt-2 ml-4 space-y-1 border-l-2 border-blue-200 pl-3 animate-in slide-in-from-top-2 duration-300">
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          pathname === subitem.href
                            ? "bg-blue-50 text-blue-700 font-medium shadow-sm border border-blue-200/50"
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div className={cn(
                            ...
                            pathname === subitem.href ? "bg-blue-500 shadow-sm" : "bg-gray-400 group-hover:bg-blue-500"
                          )}></div>
                          {subitem.label}
                        </div>
                      </Link>
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            <div className="text-xs text-gray-600 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center shadow-sm">
                  <span className="text-xs font-bold text-blue-700">A</span>
                </div>
                <p className="font-medium">© 2025 OffersMeta</p>
              </div>
              <div className="flex space-x-2">
                <a href="#" className="text-gray-400 hover:text-blue-600 transition-all duration-200 hover:scale-110 p-0.5 rounded">
