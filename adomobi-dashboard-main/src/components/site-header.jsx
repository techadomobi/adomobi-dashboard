      ...
      <div className="flex h-16 items-center px-6 gap-6">
        ...
        <div className="flex items-center gap-4 flex-1">
          <Button variant="ghost" size="icon" className="md:hidden" onClick={() => setIsOpen((prev) => !prev)}>
            <Menu className="h-6 w-6 text-gray-800 dark:text-white transition-all hover:text-blue-600 dark:hover:text-blue-400" />
          </Button>

          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-semibold text-blue-600 dark:text-white transition-all hover:text-blue-700 dark:hover:text-blue-400">
              Dashboard
            </h1>
          </div>
        </div>
        ...
        <div className="hidden m-2 md:flex items-center gap-4 bg-blue-50 dark:bg-gray-700 rounded-md px-4 py-2 shadow-sm">
          <Wallet2 className="h-5 w-5 text-blue-600 dark:text-gray-400" />
          <div className="flex flex-col items-start">
            ...
            <span className="text-lg font-semibold text-blue-700 dark:text-blue-400">$0.00</span>
          </div>
        </div>
        ...
        <Button
          size="sm"
          className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white shadow-md transition-all"
        ...
        <Button
          variant="ghost"
          size="icon"
          className="hidden md:inline-flex text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all"
        >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              {/* User Avatar */}
              <div className="relative w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white font-bold text-sm shadow-sm">
          ...
          <DropdownMenuContent className="w-56 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 shadow-md rounded-md">
            ...
            <div className="flex items-center gap-3 p-3">
              <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white font-bold text-lg shadow-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-blue-600 dark:text-blue-400 capitalize">{displayUserType}</span>
              </div>
            </div>
            <DropdownMenuSeparator className="bg-gray-200 dark:bg-gray-700 my-1" />

            <DropdownMenuItem className="hover:bg-blue-100 dark:hover:bg-blue-600 transition-all cursor-pointer">
