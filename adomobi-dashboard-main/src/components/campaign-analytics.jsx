  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-indigo-600 hover:bg-indigo-700 text-white">Show</Button>
      </div>
          ...
          <TableBody>
            {campaigns.map((campaign) => (
              ...
              >
                ...
                <TableCell>
                  <span className="inline-flex items-center px-2 py-1 rounded-md bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200 text-xs">
                    {campaign.adFormat}
                  </span>
                </TableCell>
