...
export function DataTables() {
  ...
  React.useEffect(() => {
    const fetchOffers = async (partners_Id, advertiserId) => {
      setIsLoading(true);
      setError(null);
      try {
        const token = localStorage.getItem("authToken");
        const response = await fetch(
          `${API_BASE}offer/advertiserOfferList?partners_Id=${partners_Id}&advertiserId=${advertiserId}`,
          {
            headers: {
    ...
    try {
      ...
      if (advertiserDataString) {
        ...
        // Use partners_Id or _id as fallback
        ...
        if (partners_Id && advertiserId) {
          fetchOffers(partners_Id, advertiserId);
        } else {
        ...
        setError("Advertiser data not found in local storage.");
        setIsLoading(false);
      }
    } catch (e) {
  ...
  const getStatusBadge = (status) => {
    const statusStyles = {
      ACTIVE: "bg-blue-100 text-blue-700 border-blue-200 shadow-sm",
    ...
    <div className="space-y-6 p-6 bg-gray-50/30 min-h-screen">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg hover:shadow-xl transition-all duration-200 px-6 py-2.5">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2.5 w-80 bg-white border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 rounded-lg shadow-sm"
                  value={searchTerm}
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  paginatedOffers.map((offer, index) => (
                    <TableRow 
                      key={offer.id} 
                      className="border-b border-gray-50 hover:bg-blue-50/30 transition-all duration-200 cursor-pointer group"
