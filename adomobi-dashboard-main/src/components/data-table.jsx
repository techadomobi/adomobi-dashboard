      ...
      <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
          <Popover className="relative">
            <div ref={popoverButtonRef} onClick={handleCalendarClick}>
                <Button variant="outline" className="flex items-center text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900 rounded-md border border-blue-200 dark:border-blue-700">
              ...
              <Transition
                ...
                <PopoverPanel className="absolute z-20 mt-2 w-72 rounded-md bg-white shadow-lg ring-1 ring-gray-300 dark:bg-gray-700 dark:ring-gray-600 p-2">
                    <div className="flex items-center justify-between mb-2">
                      <Button variant="ghost" onClick={handlePrevMonth} className="h-8 w-8 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-600 rounded-md">
                      ...
                      <Button variant="ghost" onClick={handleNextMonth} className="h-8 w-8 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-600 rounded-md">
                          ...
                          <button
                            ...
                            className={`rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-600
                                ${
                                  ...
                                  day >= startDate &&
                                  (!endDate || day <= endDate)
                                    ? "bg-blue-50 dark:bg-blue-700 text-blue-600 dark:text-blue-100"
                                    : ""
                                }
                                ${
                                  startDate &&
                                  ...
                                  day.getMonth() === startDate.getMonth()
                                    ? "font-medium text-blue-600 dark:text-blue-100"
                                    : ""
                                }
                                ${
                                  endDate &&
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            className="text-gray-700 hover:bg-blue-50 dark:text-gray-300 dark:hover:bg-blue-900 rounded-md border border-blue-200 dark:border-blue-700"
          >
          ...
          <Button
            variant="ghost"
            className="text-gray-700 hover:bg-blue-50 dark:text-gray-300 dark:hover:bg-blue-900 rounded-md"
          >
          ...
          <Button
            variant="ghost"
             className="text-gray-700 hover:bg-blue-50 dark:text-gray-300 dark:hover:bg-blue-900 rounded-md"
          >
            <RotateCw className="w-4 h-4 text-blue-500 dark:text-blue-400" />
          </Button>
        </div>
      </div>
