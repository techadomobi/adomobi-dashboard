  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
        ...
        <DialogHeader className="p-6 pb-4 border-b border-gray-200/50 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm">
          <DialogTitle className="flex justify-between items-center text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-purple-700">
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-4 py-2 text-lg font-bold border-2 border-blue-300 focus:border-blue-500 rounded-xl shadow-inner transition-all duration-200 focus:ring-2 focus:ring-blue-200"
                placeholder="e.g., 100"
              />
            </div>
          </div>
          ...
          <div className="space-y-4 rounded-xl p-5 bg-gradient-to-br from-gray-50 to-white shadow-lg border border-gray-200 animate-fade-in">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center pt-4 border-t-2 border-blue-200/50 font-bold text-xl text-gray-900">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="coupon" className="border-blue-400 data-[state=checked]:bg-blue-600 data-[state=checked]:text-white" />
        ...
        <DialogFooter className="flex flex-col sm:flex-row sm:justify-end gap-3 p-6 pt-4 border-t border-gray-200/50 bg-gray-50/50 backdrop-blur-sm">
          ...
          <Button
            ...
            className="w-full sm:w-auto px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg shadow-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-xl"
          >
            Add Funds
          </Button>
        </DialogFooter>
