...
const ProfileDetail = ({ icon: Icon, label, value }) => (
  <div className="flex items-start gap-4 py-3">
    ...
    <Icon className="h-5 w-5 text-indigo-600 mt-1 flex-shrink-0" aria-hidden="true" />
...
export function AdvertiserProfile() {
  ...
  return (
    <Card className="max-w-7xl w-full mx-auto rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-[1.005] hover:shadow-blue-500/20">
      {/* --- Vibrant Gradient Header --- */}
      <CardHeader className="relative bg-gradient-to-br from-purple-500 via-indigo-500 to-blue-500 p-8 sm:p-10 text-white flex flex-col items-center sm:flex-row sm:items-end justify-between">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-end gap-6 w-full">
          ...
          <div className="flex-1 text-center sm:text-left mt-4 sm:mt-0">
            ...
            <CardDescription className="text-xl text-blue-100 mt-2 font-medium [text-shadow:_0_2px_4px_rgb(0_0_0_/_20%)]">
      ...
      <CardContent className="bg-white p-6 md:p-10 grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-8">
        ...
        <div className="bg-gray-50 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-5 pb-3 border-b-2 border-indigo-500 flex items-center gap-2">
            <Mail className="h-6 w-6 text-indigo-500" /> Contact Information
          </h3>
        ...
        <div className="bg-gray-50 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-5 pb-3 border-b-2 border-blue-500 flex items-center gap-2">
            <User className="h-6 w-6 text-blue-500" /> Account Details
          </h3>
      ...
      <CardFooter className="bg-gray-100 border-t border-gray-200 p-6 flex justify-end gap-4 rounded-b-3xl">
        ...
        {/*
        <Button variant="outline" className="text-indigo-600 border-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 shadow-sm transition-all duration-200">
          <KeyRound className="mr-2 h-4 w-4" /> Change Password
        </Button>
        <Button className="bg-blue-600 hover:bg-blue-700 text-white shadow-md transition-all duration-200">
