...
export function MetricsCard({ cardType }) {
    const cardData = {
            ...
            additionalContent: (
              <div className="mt-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-1">
                      <li><span className="text-blue-500">Global demand</span> access.</li>
                      <li><span className="text-green-500">Real-time bidding</span> for optimal yield.</li>
                      <li><span className="text-purple-500">Detailed analytics</span> for insights.</li>
                      <li><span className="text-teal-500">Dedicated support</span> to maximize performance.</li>
                  </ul>
        ...
        ADX: {
            title: <span className="text-green-500">Monetize with OffersMeta</span>,
            ...
            metrics: [
                ...
                { label: "Fill Rate", value: "0.00%", color: "text-purple-500" },
                { label: "Revenue", value: "$0.00", color: "text-teal-500" },
        ...
        <Card className="overflow-hidden shadow-md dark:bg-gray-800">
             ...
             <CardContent>
                ...
                {!card.additionalContent && (
                    <Button
                        variant="link"
                        className="px-0 text-blue-500 dark:text-blue-400 hover:no-underline"
                    >
