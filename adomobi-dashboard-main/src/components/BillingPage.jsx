    ...
    return (
        <div className="min-h-screen py-4 px-2 sm:px-6 lg:px-8">
            <Card className="w-full max-w-8xl mx-auto rounded-2xl overflow-hidden bg-white shadow-xl border border-gray-200">
                <CardHeader className="space-y-1 p-6 bg-teal-200 text-white">
                    <CardTitle className="text-3xl text-teal-900 font-bold flex items-center">
                ...
                <CardContent className="p-6 lg:p-10">
                    ...
                    {/* <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                        <User className="w-6 h-6 mr-2 text-teal-600" /> Your Billing Profile
                    </h2> */}
                    <Form {...form}>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                                    <User className="w-5 h-5 mr-2 text-blue-600" /> Basic Billing Details
                                </h3>
                                <FormField
                                    control={control}
                                    name="name"
                            ...
                            <div className="space-y-4 pt-6 border-t border-gray-200">
                                <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                                    <Building className="w-5 h-5 mr-2 text-blue-600" /> Company Details
                                </h3>
                                <FormField
                                    control={control}
                                    name="gstNo"
                            ...
                            <div className="space-y-4 pt-6 border-t border-gray-200">
                                <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                                    <MapPin className="w-5 h-5 mr-2 text-blue-600" /> Billing Address
                                </h3>
                                <FormField
                                    control={control}
                                    name="billingCountry"
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-teal-500 hover:bg-teal-600 text-white py-2 rounded-md transition-colors"
                            >
                                Submit for Demo 
                            </Button>
                        </form>
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                        <FileText className="w-6 h-6 mr-2 text-teal-600" /> Your Invoices
                    </h2>
