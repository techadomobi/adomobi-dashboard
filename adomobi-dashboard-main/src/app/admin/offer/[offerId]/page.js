      ...
      <Card className="max-w-8xl mx-auto shadow-lg shadow-slate-200/50">
        ...
        <CardContent className="p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            <div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-blue-500/50">Offer Details</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-teal-500/50">Advertiser Info</h3>
            ...
            {offer.landingPage && offer.landingPage.length > 0 && (
              <div className="md:col-span-2 mt-4">
                <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-indigo-500/50">Landing Page Details</h3>
