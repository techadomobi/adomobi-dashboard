      ...
      <Card className="max-w-8xl mx-auto shadow-lg shadow-slate-200/50">
        ...
        <CardContent className="p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            <div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-blue-500/50">Campaign Details</h3>
            ...
            <div>
              {/* <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-blue-500/50">Advertiser Info</h3> */}
            ...
            {offer.description && (
              <div className="md:col-span-2 mt-4">
                <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-purple-500/50">Description</h3>
                <div 
            ...
            {offer.landingPage && offer.landingPage.length > 0 && (
              <div className="md:col-span-2 mt-4">
                <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-indigo-500/50">Default Tracking Links</h3>
                  ...
                  <div key={lp._id || index} className="bg-slate-50 p-4 rounded-lg mb-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <DetailItem icon={Globe} label="Tracking URL">
                        <a href={lp.trackingUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all text-sm">
                          {lp.trackingUrl}
                        </a>
                      </DetailItem>
                      <DetailItem icon={Globe} label="Impression URL">
                        <a href={lp.impressionUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all text-sm">
                          {lp.impressionUrl}
                        </a>
                      </DetailItem>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                {offer.previewUrl && (
                  <DetailItem icon={Globe} label="Preview URL">
                    <a href={offer.previewUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all text-sm">
                      {offer.previewUrl}
                    </a>
                  </DetailItem>
                )}
                {offer.fallbackUrl && (
                  <DetailItem icon={Globe} label="Fallback URL">
                    <a href={offer.fallbackUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all text-sm">
                      {offer.fallbackUrl}
                    </a>
                  </DetailItem>
                )}
              ...
              <div className="md:col-span-2 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {offer.event.map((evt, index) => (
                    <div key={evt._id || index} className="bg-slate-50 p-4 rounded-lg border-l-4 border-blue-500">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-bold text-blue-600">{evt.profit}</span>
                        </div> */}
                      </div>
                    </div>
                  ))}
            ...
            <div className="md:col-span-2 mt-4">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 pb-2 border-b-2 border-purple-500/50">Schedule</h3>
